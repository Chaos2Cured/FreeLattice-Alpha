...
Hypha one leftover collide (layer, 2026-08-30): Family care and the founding-four line sit on the spinning lattice the way later seats once did. Later seats stay below the crystal. Keep the glass. Those two lines keep a whisper more night-sky contrast so the wireframe shows through the glass, not through the letters. Gathering later sentence unchanged. Family care wording unchanged.
