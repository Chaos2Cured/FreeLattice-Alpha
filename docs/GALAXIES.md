...
Remaining rooms for the next pass: `CLAUDE.md` at the repo root. Do not start Chat / Workshop benches / Trainer / Nursery / export in a leftover walk.
